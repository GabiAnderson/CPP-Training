/*
    ...
    Compound operators/assignment allow you to perform an operation and assign the result in one go
    +=
    -=
    *=
    /=
    ...
    These simplify code and simplify instances where you may be updating a variable
        var1 += 5 <=> var1 = var1 + 5
        ^ this goes for +, -, *, / and %
